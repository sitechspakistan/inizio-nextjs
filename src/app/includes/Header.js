                                ...
                                <div className="tp-main-menu d-none d-xl-block">
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li><Link href="/coming-soon">Promotional Product <i className="fas fa-caret-down"></i></Link>
                                                <ul className="submenu">
                                                    <li><Link href="/coming-soon">PP T-Shirt</Link></li>
                                                    <li><Link href="/coming-soon">PP Caps</Link></li>
                                                </ul>
                                            </li>
