                    ...
                    <div className="col-xl-4 col-lg-4 col-md-3 col-12 mb-30">
                        <div className="tp-footer-widget z-index-3">
                            <div className="row g-20">
                                <div className="tp-footer-widget__social1 mb-20">
                                    <a href="#">
                                        <div>
                                            <img src="/assets/images/payment/paypal.webp" alt="" className="img1" />
                                        </div>
                                ...
                                <div className="tp-footer-widget__social1 mb-20">
                                    <a href="#">
                                        <div>
                                            <img src="/assets/images/payment/norton.webp" alt="" className="img-2" width="100"
                                            height="62" />
                                        </div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-12">
                                        <div className="copyright-right-side text-lg-end">
                                            <div className="footer-font"><a href="">
                                                <span><i className="fa fa-facebook" id="facebook"></i></span>
                                                <span><i className="fa fa-instagram" id="instagram"></i></span>
                                                <span><i className="fa fa-linkedin" id="linkedin"></i></span>
                                            </a>
                                            </div>
                                        </div>
                                    </div>
