                            ...
                            <div className="tp-hero">
                                <div className="tp-hero__section-box">
                                    <span className="tp-section-subtitle  wow tpfadeUp" data-wow-duration=".7s"
                                        ...
                                        Best solution we offer you</span>
                                    <h1 className="tp-slider-title wow tpfadeUp" data-wow-duration=".7s"
                                        data-wow-delay=".6s"
                                        style={{
                                            visibility: "visible",
                                            animationDuration: "0.7s",
                                        ...
                                        Make a good plan &amp; grow your business</h1>
                                    <p className="wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".8s"
                                        style={{
                                            visibility: "visible",
                                            animationDuration: "0.7s",
                                            animationDelay: "0.6s",
                                        ...
                                        We have almost 12+ years of experience for helping consulting services and
                                        business
                                        solutions. </p>
                                </div>
                            </div>
