...
const ChatBot = () => {
    ...
    const submitLead = async () => {
        ...
        try {
            ...
            await pushBot({
                type: 'text',
                content: '❌ Something went wrong. Please email us directly at orders@iniziosolutions.com',
            })
        }
    }
        ...
        <div>
            ...
            {mode === 'teaser' && (
                <div className="wb-chat-teaser">
                    ...
                    <h4>Hey there!</h4>
                    <p>I'm Inizio Solutions Assistant.<br />How can I help you today?</p>
