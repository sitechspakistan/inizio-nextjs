               ...
               <div className="row align-items-center">
                  ...
                  <div className="col-xl-5 col-lg-5 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".7s"
                     ...
                     <div className="tp-ab-section-title-box">
                        <h2 className="tp-section-title">We Operate Globally To Prioritize You</h2>
                        <p>Inizio Solutions operates globally, to navigate your success from anywhere, at any time. We
                           feel
